...
class ProductController extends BehaviorsController
{
    ...
    {
        if(empty(Yii::$app->request->queryParams['ProductSearch']['shop_id']) && empty(Yii::$app->request->queryParams['ProductSearch']['id'])) return $this->redirect('error');
...
//        }
    ...
    public function actionDelete($id)
    {
        ...
        $product->delete();
        return $this->redirect(['index', 'ProductSearch[shop_id]' => Yii::$app->session->get('shop_id')]);
    }
//
//    /**
