...
use backend\models\ExpensesCategoriesSearch;
 ...
 */
class ExpensesCategoriesController extends BehaviorsController
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new ExpensesCategoriesSearch();
    ...
    {
        if (($model = ExpensesCategories::findOne($id)) !== null) {
            return $model;
        } else {
