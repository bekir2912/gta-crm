 ...
 */
class AnnouncementController extends BehaviorsController
{
    ...
    {
        if(empty(Yii::$app->request->queryParams['ProductSearch']['user_id']) && empty(Yii::$app->request->queryParams['ProductSearch']['id'])) return $this->redirect('error');
...
//    }
    ...
    {
        if(empty(User::findOne(Yii::$app->session->get('user_id')))) return $this->redirect(['announcement/index']);
...
//        }
    ...
    public function actionDelete($id)
    {
        ...
        $product->delete();
        return $this->redirect(['index', 'ProductSearch[user_id]' => Yii::$app->session->get('user_id')]);
    }
//
//    /**
